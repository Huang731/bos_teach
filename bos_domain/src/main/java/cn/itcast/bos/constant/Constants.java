...
public class Constants {
	...
	public static final String CRM_MANAGEMENT_HOST = "http://localhost:8081";
	public static final String BOS_FORE_HOST = "http://localhost:8082";
	public static final String BOS_SMS_HOST = "http://localhost:8083";
	public static final String BOS_MAIL_HOST = "http://localhost:8084";
